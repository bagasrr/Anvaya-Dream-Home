...
const AdvantageCard = (props) => {
  ...
  return (
    <div className="w-40 sm:w-1/4 shadow-lg justify-center bg-slate-200 p-5 rounded-lg hover:scale-105 duration-300">
...
const HomeTypeCard = (props) => {
  ...
  return (
    <div className="w-32 sm:w-1/6 h-44 sm:h-72 shadow-lg align-center justify-center bg-slate-200 rounded-lg m-5 hover:scale-105 duration-300 ">
